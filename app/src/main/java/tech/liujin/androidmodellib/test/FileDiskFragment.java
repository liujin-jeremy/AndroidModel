...
import tech.liujin.cache.file.BaseFileLoader;
import tech.liujin.cache.file.loader.DiskLruLoader;
 ...
 */
public class FileDiskFragment extends Fragment implements OnClickListener {
      ...
      public static FileDiskFragment newInstance ( ) {
            ...
            FileDiskFragment fragment = new FileDiskFragment();
